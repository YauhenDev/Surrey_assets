export const ru = {
	...
	aboutUs: {
		h2		: "Vision Statement",
		txt1	: "<ul><li>Customer-Oriented: achieving mutually beneficial relationships with our customers through long-lasting business experience</li><li>Committed to Growth: hand-picking and training the best and most experienced team in the business, able to master organic personal and company growth while maintaining contract-to-payment full control, providing employees a fulfilling work environment</li></ul>",
	...
	error404: {
		...
		seoTitle	: "404 О-о-о, нет! Вы потерялись",
